...
export const CatIcon = React.forwardRef<SVGSVGElement, CritterIconProps>(
  (props, ref) => (
    <IconFrame ref={ref} {...props}>
      ...
      <path d="M9.5 11.8h.01M14.5 11.8h.01M12 13.4h.01" />
      <path d="M12 13.5c-.3.7-.9 1.1-1.6 1.1M12 13.5c.3.7.9 1.1 1.6 1.1" />
...
export const DogIcon = React.forwardRef<SVGSVGElement, CritterIconProps>(
  (props, ref) => (
    <IconFrame ref={ref} {...props}>
      ...
      <path d="M7.8 9C6.4 7 4.2 5.9 3.4 7c-.9 1.2-.1 5.9 1.6 7.2 1 .8 2.3-.2 2.3-1.7M16.2 9l3.9-2.3-.5 4.8" />
